    ...
    const fetchStats = async () => {
      try {
        const [registerVehicle, registerOrder] = await Promise.all([
          axios.get(`https://subattenuated-epithetically-eryn.ngrok-free.dev/api/registerVehicle/count/${idCollector}`),
          axios.get(`https://subattenuated-epithetically-eryn.ngrok-free.dev/api/registerOrder/status/count/${idCollector}`)
        ]);
