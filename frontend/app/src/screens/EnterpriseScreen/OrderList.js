...
export default function OrderList() {
  ...
  const getOrders = async () => {
    ...
    try {
      const response = await axios.get(`https://subattenuated-epithetically-eryn.ngrok-free.dev/api/registerOrder`, {
        params: { idCollector }
      });
  ...
  const handleAccept = async (order) => {
    ...
    try {
      ...
      await axios.put(`https://subattenuated-epithetically-eryn.ngrok-free.dev/api/registerOrder/${orderId}`, payload);
  ...
  const handleReject = async (order) => {
    ...
    try {
      await axios.post(`https://subattenuated-epithetically-eryn.ngrok-free.dev/api/registerOrder/${orderId}/reject`, {
        idCollector
      });
