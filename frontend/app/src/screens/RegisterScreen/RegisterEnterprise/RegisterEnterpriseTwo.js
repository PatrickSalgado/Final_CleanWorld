...
export default function RegisterEnterpriseTwo({ navigation, route }) {
  ...
  const handleRegister = async () => {
    ...
    try {
      const response = await axios.post(`https://subattenuated-epithetically-eryn.ngrok-free.dev/api/collector`, {
        nameEnterprise,
        cnpj,
        phone,
        userType,
  ...
  return (
    <LinearGradient colors={['#3CB371', '#2E8B57']} style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <Animatable.View animation="fadeInDown" delay={400} duration={700} style={styles.headerBox}>
